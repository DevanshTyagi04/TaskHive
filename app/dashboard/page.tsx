...
import { Dice1, Filter, Grid3X3, List, Loader2, Plus, Rocket, Search, Trello } from "lucide-react";
                    ...
                    <Card>
                        <CardContent className="p-4 sm:p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="h-10 w-10 sm:h-12 w-13=2 bg-blue-100 rounded-lg flex items-center justify-center">
                    ...
                    <Card>
                        <CardContent className="p-4 sm:p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="h-10 w-10 sm:h-12 w-13=2 bg-green-100 rounded-lg flex items-center justify-center">
                    ...
                    <Card>
                        <CardContent className="p-4 sm:p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="h-10 w-10 sm:h-12 w-13=2 bg-purple-100 rounded-lg flex items-center justify-center">
                                    📊
                                </div>
                            </div>
                        </CardContent>
                ...
                <div className="mb-6 sm:mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                            <div className="flex items-center space-x-2 rounded-lg bg-white border p-1">
                                <Button 
                                ...
                                <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
                                    <CardHeader className="pb-3">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Badge variant="secondary" className="text-sx">New</Badge>
                                        </div>
                                    </CardHeader>
                                    <CardContent className="p-4 sm:p-6">
