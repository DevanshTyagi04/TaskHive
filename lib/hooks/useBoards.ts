...
import { useSupabase } from "../supabase/SupbaseProvider";
...
export function useBoards(){
    ...
    async function loadBoards(){
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : "Falied to load boards.")
        } finally {
            setLoading(false);
        }
    }
    ...
    async function createBoard(boardData : {
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : "Falied to create board.")
        }
    }
...
export function useBoard(boardId: string){
    ...
    async function updateBoard(boardId: string, updates: Partial<Board>){
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : "Falied to update the board.")
        }
    }
    ...
    newOrder: number
      ...
      try{
        ...
        setColumns((prev) => {
            ...
            // Find and remove task fo=rom the old column
